...
class TvShowProvider extends ChangeNotifier {
  ...
  Future<void> searchTvShows(String query) async {
    try {
      ...
      _errorMessage = "An error occurred while searching for TV shows.";
      notifyListeners();
    }
  }
  ...
  Future<void> fetchTvShowTrailers(int tvShowid) async {
    try {
      ...
      _errorMessage = "Failed to load TV show trailers. Please try again.";
      notifyListeners();
    }
  }
  ...
  Future<void> fetchAiringTodayTVShows() async {
    try {
      ...
      _errorMessage =
          "Failed to fetch airing today TV shows. Please try again.";
      notifyListeners();
    }
  }
  ...
  Future<void> fetchTopRatedTVShows() async {
    try {
      ...
      _errorMessage = "Failed to fetch top-rated TV shows. Please try again.";
      notifyListeners();
    }
  }
  ...
  Future<void> fetchOnTheAirTVShows() async {
    try {
      ...
      _errorMessage =
          "Failed to fetch TV shows currently on air. Please try again.";
      notifyListeners();
    }
  }
  ...
  Future<void> fetchTrendingTVShows() async {
    try {
      ...
      _errorMessage = "Failed to fetch trending TV shows. Please try again.";
      notifyListeners();
    }
  }
  ...
  Future<Credits?> fetchTvShowCast(int tvShowId) async {
    try {
      ...
      _errorMessage =
          "Failed to load TV show cast information. Please try again.";
      notifyListeners();
    }
    return null;
  }
  ...
  Future<void> fetchSimilarTvShow(int tvShowId) async {
    try {
      ...
      _errorMessage = "Failed to fetch similar TV shows. Please try again.";
      notifyListeners();
    }
  }
}
